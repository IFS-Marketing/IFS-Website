const cursor = document.querySelector('.cursor');
  ...
  function applyPortfolioFilter(){
    document.querySelectorAll('.project').forEach(card=>{
      const isAISubcard = card.classList.contains('ai-card');
      ...
      const showCard = !isAISubcard && activeMainFilter === 'all'
        ? true
        : (!isAISubcard && mainMatch && aiMatch) ||
          (isAISubcard && activeMainFilter === 'ai' && mainMatch && aiMatch);
